...
def _unresolved_row(file_hash: str, source: str, error_type: str, gt_pyc: Path | None, derived_pyc: Path | None) -> dict:
    return {
        ...
        "sum_instruction_distance": None,
        "sum_control_flow_distance": None,
        "sum_interaction_penalty": None,
        "sum_unmatched_penalty": None,
        "sum_code_object_normalized_instruction_distance": None,
        "mean_code_object_normalized_instruction_distance": None,
        "mean_code_object_normalized_cfg_distance": None,
        "mean_code_object_normalized_interaction_penalty": None,
        "mean_code_object_normalized_unmatched_penalty": None,
        "control_flow_weight": None,
        "sum_combined_distance": None,
        "mean_code_object_normalized_combined_distance": None,
