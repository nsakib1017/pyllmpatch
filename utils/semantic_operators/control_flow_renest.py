...
def control_flow_renest_candidate(gt_code_object, derived_code_object, fragment: str,
    ...
    try:
        return _control_flow_renest_candidate(gt_code_object, derived_code_object, fragment, repair_context)
...
def _control_flow_renest_candidate(gt_code_object, derived_code_object, fragment: str, repair_context: dict | None) -> dict | None:
