...
def container_construction_candidate(gt_code_object, derived_code_object, fragment: str,
    ...
    try:
        return _container_construction_candidate(gt_code_object, derived_code_object, fragment, repair_context)
...
def _container_construction_candidate(gt_code_object, derived_code_object, fragment: str, repair_context: dict | None) -> dict | None:
