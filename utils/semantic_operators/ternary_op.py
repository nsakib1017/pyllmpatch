...
def ternary_op_candidate(gt_code_object, derived_code_object, fragment: str,
    ...
    try:
        return _ternary_op_candidate(gt_code_object, derived_code_object, fragment, repair_context)
...
def _ternary_op_candidate(gt_code_object, derived_code_object, fragment: str, repair_context: dict | None) -> dict | None:
