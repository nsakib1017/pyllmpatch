"""Version-agnostic opcode families (CPython 3.10-3.15).

The deterministic operators were written against 3.10-3.13 opnames. 3.14 renamed/added several
load and jump opcodes (e.g. LOAD_FAST_BORROW, LOAD_SMALL_INT, JUMP_IF_FALSE/TRUE) and removed
others (LOAD_METHOD, RETURN_CONST). Rather than hardcoding names in each operator, operators can
consult these FACTUAL family sets/predicates so they keep firing across versions. The membership
here is verified against the real 3.14/3.15 opcode inventories in tests/test_opcode_families.py.
"""
