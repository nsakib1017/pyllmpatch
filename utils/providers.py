...
OPEN_LLM_MODELS =  [
    ...
    {'provider': 'Alibaba', 'name': 'qwen2.5-coder-32b', 'token_for_completion': 32768, 'model_path': f"{os.getenv('PROJECT_ROOT_DIR')}/finetuning/merged_model_qwen2.5_coder_32b_instruct_15_epochs"}
]
