...
ACCEPTED_CODE_OBJECT_FILE = str(os.getenv("ACCEPTED_CODE_OBJECT_FILE", "semantic_repair_accepted_code_objects.jsonl"))
ACCEPTED_CODE_OBJECT_TELEMETRY_FILE = str(os.getenv("ACCEPTED_CODE_OBJECT_TELEMETRY_FILE", "semantic_repair_accepted_case_telemetry.jsonl"))
ACCEPTED_CODE_OBJECT_PATH = PROJECT_ROOT_DIR / "dataset" / ACCEPTED_CODE_OBJECT_FILE
ACCEPTED_CODE_OBJECT_TELEMETRY_PATH = PROJECT_ROOT_DIR / "dataset" / ACCEPTED_CODE_OBJECT_TELEMETRY_FILE
